...
class MarkdownComponents:
    ...
    @staticmethod
    def file_header(file_path: Union[str, Path], relative_to: Optional[Union[str, Path]] = None) -> str:
        """
    ...
    @staticmethod
    def file_content(file_path: Union[str, Path], content: str, syntax_highlighting: bool = True) -> str:
        """
